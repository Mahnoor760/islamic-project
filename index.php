...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="index.php">Islamic Library</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="quran.php">Quran</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="prayercalender.php">Prayer Calender</a>
                </li>
            </ul>
